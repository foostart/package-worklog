...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        {!! Form::open(['route'=>['worklogs.delete', 'id' => @$item->id], 'method' => 'get', 'class'=>'form-responsive'])  !!}

                            @include('package-worklog::admin.worklog-item')
            ...
            <!--SEARCH-->
            <div class="col-md-3">
                @include('package-worklog::admin.worklog-search')
            </div>
            <!--/SEARCH-->
